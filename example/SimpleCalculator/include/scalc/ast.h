...
using UnitItem = std::variant<std::shared_ptr<ASTNodeFunctionDef>,
...
class ASTNodeVisitor
{
  public:
    ...
    virtual void visitForStat(const ASTNodeExprList*,
                              const ASTNodeExpr*,
    ...
    virtual void
    visitFuncDef(const std::string&, const std::vector<std::string>&, const ASTNodeBlockStat&) = 0;
...
class ASTNode
{
  ...
  public:
    ...
    {}
    inline ASTNodeParserContext context()
    {
        return this->m_parser_context;
    }
...
class UnaryOperatorExpr : public ASTNodeExpr
{
  ...
  public:
    inline UnaryOperatorExpr(ASTNodeParserContext c,
...
class BinaryOperatorExpr : public ASTNodeExpr
{
  ...
  public:
    inline BinaryOperatorExpr(ASTNodeParserContext c,
    ...
    BinaryOperatorType op() const
    {
        return m_operator;
    }
    const ASTNodeExpr& left() const
    {
        return *m_left;
    }
    const ASTNodeExpr& right() const
    {
        return *m_right;
    }
...
class IDExpr : public ASTNodeExpr
{
  ...
  public:
    inline IDExpr(ASTNodeParserContext c, std::string id) : ASTNodeExpr(c), _id(id)
    {}
...
class NumberExpr : public ASTNodeExpr
{
  ...
  public:
    inline NumberExpr(ASTNodeParserContext c, double val) : ASTNodeExpr(c), val(val)
    {}
...
class ASTNodeExprList : public ASTNode, private std::vector<std::shared_ptr<ASTNodeExpr>>
{
  ...
  public:
    ...
    inline ASTNodeExprList(ASTNodeParserContext c) : ASTNode(c)
    {}
...
class FunctionCallExpr : public ASTNodeExpr
{
  ...
  public:
    inline FunctionCallExpr(ASTNodeParserContext c,
                            std::shared_ptr<ASTNodeExpr> func,
                            std::shared_ptr<ASTNodeExprList> parameters)
        : ASTNodeExpr(c), _func(func), _parameters(parameters)
    {}

    inline std::shared_ptr<ASTNodeExpr> function()
    {
        return this->_func;
    }
    inline std::shared_ptr<ASTNodeExprList> parameters()
    {
        return this->_parameters;
    }
    inline const std::shared_ptr<ASTNodeExpr> function() const
    {
        return this->_func;
    }
    inline const std::shared_ptr<ASTNodeExprList> parameters() const
    {
        return this->_parameters;
    }
...
class ASTNodeStatList : public ASTNode, private std::vector<std::shared_ptr<ASTNodeStat>>
{
  ...
  public:
    ...
    inline ASTNodeStatList(ASTNodeParserContext c) : ASTNode(c)
    {}
...
class ASTNodeBlockStat : public ASTNodeStat
{
  ...
  public:
    inline ASTNodeBlockStat(ASTNodeParserContext c, std::shared_ptr<ASTNodeStatList> statlist)
        : ASTNodeStat(c), _statlist(statlist)
    {}

    inline std::shared_ptr<ASTNodeStatList> StatementList()
    {
        return this->_statlist;
    }
    inline const std::shared_ptr<ASTNodeStatList> StatementList() const
    {
        return this->_statlist;
    }
    ...
    void accept(ASTNodeVisitor& visitor) const override
    {
        visitor.visitBlockStat(*_statlist);
    }
};
...
class ASTNodeExprStat : public ASTNodeStat
{
  ...
  public:
    inline ASTNodeExprStat(ASTNodeParserContext c, std::shared_ptr<ASTNodeExprList> el)
        : ASTNodeStat(c), _exprlist(el)
    {}

    inline std::shared_ptr<ASTNodeExprList> exprList()
    {
        return this->_exprlist;
    }
    inline const std::shared_ptr<ASTNodeExprList> exprList() const
    {
        return this->_exprlist;
    }
    ...
    void accept(ASTNodeVisitor& visitor) const override
    {
        visitor.visitExprStat(*_exprlist);
    }
};
...
class ASTNodeReturnStat : public ASTNodeStat
{
  ...
  public:
    inline ASTNodeReturnStat(ASTNodeParserContext c, std::shared_ptr<ASTNodeExpr> expr)
...
class ASTNodeIFStat : public ASTNodeStat
{
  ...
  public:
    inline ASTNodeIFStat(ASTNodeParserContext c,
    ...
    void accept(ASTNodeVisitor& visitor) const override
    {
        visitor.visitIfStat(*_cond, *_truestat, _falsestat.get());
    }
};
...
class ASTNodeFORStat : public ASTNodeStat
{
  ...
  public:
    inline ASTNodeFORStat(ASTNodeParserContext c,
                          std::shared_ptr<ASTNodeExprList> pre,
                          std::shared_ptr<ASTNodeExpr> condition,
                          std::shared_ptr<ASTNodeExprList> post,
                          std::shared_ptr<ASTNodeStat> stat)
        : ASTNodeStat(c), _cond(condition), _stat(stat), _pre(pre), _post(post)
    {}
    ...
    inline std::shared_ptr<ASTNodeExprList> pre()
    {
        return this->_pre;
    }
    inline std::shared_ptr<ASTNodeExprList> post()
    {
        return this->_post;
    }
    ...
    void accept(ASTNodeVisitor& visitor) const override
    {
        visitor.visitForStat(_pre.get(), _cond.get(), _post.get(), *_stat);
    }
};
...
class ASTNodeFunctionDef : public ASTNode
{
  ...
  public:
    inline ASTNodeFunctionDef(ASTNodeParserContext c,
                              std::shared_ptr<ASTNodeExpr> func,
    ...
    inline std::shared_ptr<ASTNodeArgList> argList()
    {
        return this->arglist;
    }
    inline std::shared_ptr<ASTNodeBlockStat> blockStat()
    {
...
class ASTNodeFunctionDecl : public ASTNode
{
  ...
  public:
    inline ASTNodeFunctionDecl(ASTNodeParserContext c,
                               std::shared_ptr<ASTNodeExpr> func,
                               std::shared_ptr<ASTNodeArgList> args)
